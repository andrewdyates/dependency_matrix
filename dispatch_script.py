...
python $HOME/pymod/dependency_matrix/dispatch_script.py fname=$HOME/brca/GSE31448.SCAN.tab computers=[\"Cov\",\"PCC\",\"Dcor\"] outdir=$HOME/test n_nodes=10 n_ppn=12 hours=10
"""
import datetime
import random
